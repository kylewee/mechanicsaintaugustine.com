...
define('TEXT_MODULE_DADATA_TYPE_PARTY','Компании России');
define('TEXT_MODULE_DADATA_TYPE_PARTY_BY','Компании Беларуси');
define('TEXT_MODULE_DADATA_TYPE_PARTY_KZ','Компании Казахстана');
...
define('TEXT_MODULE_DADATA_ADMINISTRATIVE','Административный');
define('TEXT_MODULE_DADATA_MUNICIPAL','Муниципальный');
...
define('TEXT_MODULE_DADATA_ADD_INDEX','Подставить индекс после выбора адреса');
define('TEXT_MODULE_DADATA_ADD_COUNTRY','Подставить страну после выбора адреса');