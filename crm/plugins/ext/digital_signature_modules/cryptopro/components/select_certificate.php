...
<script language="javascript" src="js/cryptopro/js/sha256.js"></script>
  ...
  <div class="title_info" name="CertificateTitle">Выберите сертификат:</div>
   <div id="item_border" name="CertListBoxToHide">
    ...
    <div id="cert_info" style="display:none;" align="center">
       ...
       <?php echo form_tag('ecp_login',$form_action_url) ?>				       				
       	 <div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<table>
								...
								<tr>
									...
									<td><span class="cert_info_field" id="from"></span> по :<span class="cert_info_field" id="till"></span></td>
								</tr>
								<tr>
									<td>Состояние:</td>
	           ...
	           <div class="cert_item" style="display:none">In storage: <span class="cert_info_field" id="location"></span></div>
	           <input id="status_code" type="hidden" value="">
	           <input id="has_private_key" type="hidden" value="">
	
	           <div style="margin-top:20px;">
	             <input class="btn btn-primary btn btn-primary btn-sm btn-process-7" type="button" value="Выбрать" onclick="ChooseCert()">
	            </div>
 ...
 <div id="item_border">
  <textarea id="DataToSignTxtBox" name="DataToSignTxtBox" style="height:20px;width:100%;resize:none;border:0;"></textarea>    
 </div>
...
function ShowError( msg ) { return alert( "Ошибка: "+msg ), true ; }
...
function ChooseCert(){ nCryptoPro.ChooseCert();}
...
getUICertListId : function(){  return "CertListBox";},
...
nECP={
	...
	LoginTo : function (thumbprint,index,owner){		 
		 nECP.thumbprint=thumbprint; nECP.owner=owner;
