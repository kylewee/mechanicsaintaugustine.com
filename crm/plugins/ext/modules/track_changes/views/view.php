<h3 class="page-title"><?php echo $app_reports['name'] ?></h3>

<?php require(component_path('ext/track_changes/filters')) ?>
...
<script>
  ...
  {      
    ...
    $('#'+listing_container).load('<?php echo url_for("ext/track_changes/view",'reports_id=' . $app_reports['id'] .'&action=listing') ?>',{page:page,filters:filters},
